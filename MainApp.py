...
from qgis.core import QgsProject, QgsVectorLayer, Qgis, QgsMessageLog, QgsProcessingUtils, QgsCoordinateReferenceSystem, QgsVectorLayerJoinInfo
...
class MainApp(QDialog):
    ...
    def add_layers(self):
        ...
        parcely_layer = QgsProject.instance().mapLayersByName('parcely')[0]
